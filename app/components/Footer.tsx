...
export default function Footer() {
	return (
		<footer className="w-full border-t border-[#232A31] bg-[#10151A] md:px-10 flex flex-col items-center relative">
			<div className="flex flex-col items-center max-w-3xl w-full">
				<img src="/logo.png" alt="Logo" className="h-12 mb-4" />
				<p className="text-[#C7C7C7] text-center text-base mb-2">
					O escritório{" "}
					<span className="font-bold text-white">
						Pires, Carvalho & Oliveira – Advocacia Criminal
					</span>{" "}
				...
				<p className="text-[#C7C7C7] text-center text-sm">
					©2025 – Pires de Carvalho & Oliveira – Todos os direitos
					reservados.
				</p>
			</div>
		</footer>
